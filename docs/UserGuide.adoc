...
//end::login[]
== Types of Users
In small drink distribution companies, the workload can generally be split into 3 roles,
...
As a [red]#manager#, you want to create new account for new employee.
