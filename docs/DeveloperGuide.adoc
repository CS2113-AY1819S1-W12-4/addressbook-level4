...
image::LoginUMLDiagram/Login_Class_Diagram.png[width="300" height"200"]


Given below is an example usage scenario and how login mechanism behave at each step.

image::LoginUMLDiagram/Login_sequence_diagram.png[width="600" height ="300"]
The `LoginController` will check for username and password will the `LoginUtils`.


image::LoginUMLDiagram/LoginUtils_Sequence_Diagram.png[width="600" height ="300"]
...
image::LoginUMLDiagram/Logic-UML-design-ReadLoginInfoList.png[width="800" height ="300"]
...
=======
>>>>>>> parent of 4dd92168... Dgchange (#187)
...
=== Change Password
. change password after the account is given by manager.

.. Test case: `changePassword o/123 n/1234`(assuming default password is 123) +
    Expected: change password from 123 to 1234. You have to login with password 1234
.. Test case: `delete 0` +
