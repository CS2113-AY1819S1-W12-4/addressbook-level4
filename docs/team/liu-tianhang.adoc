...
* *Major enhancement*: Partition command into 3 roles (manager, accountant and stock taker)
...
Credits: http://www.appsdeveloperblog.com/encrypt-user-password-example-java/[source] Learn the use javax.crypto and other java function to hashed and verify password.
